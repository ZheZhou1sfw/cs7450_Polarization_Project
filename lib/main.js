...
new ScrollMagic.Scene({
  ...
  triggerHook: 'onLeave'
    ...
    .on('enter', function(e) {
      ...
      $('#viz1Text').text('Here, the lines represents the median ideologies of the two parties, the Republicans and the Democrats.');
    });
  ...
  triggerHook: 'onLeave'
    ...
    .on('enter', function(e) {
      ...
      $('#viz1Text').text('Feel free to explore the visualization. When ready, scroll down.');
        document.getElementsByClassName('toggleViz1Tooltips')[0].style.visibility = 'visible';
        document.getElementById('autoComplete').style.visibility = 'visible';
        verticalLineG.attr('visibility', 'visible');
        jQuery('.toggleLineChart')[0].click();
    });
...
new ScrollMagic.Scene({
    triggerElement: "#testPart15",
    triggerHook: 0.4,
    offset: -50, // move trigger to center of element
    duration: 180
})
    .setClassToggle("#testPart15", "changeColor") // add class toggle
    // add indicators (requires plugin)
    .addTo(controller);
...
new ScrollMagic.Scene({
  ...
  duration: 600,
  offset: 560, // move trigger to center of element
})
    .setPin("#politician2Place", {pushFollowers: false})
     // add indicators (requires plugin)
    .addTo(controller);
  ...
  triggerHook: 'onLeave'
    ...
    .on('enter', function() {
      $('#viz2Text').text('In the 1980s, ideologies are spread across the political spectrum.');
        // document.getElementsByClassName('toggleCentroid')[0].style.visibility = 'hidden';
        // document.getElementsByClassName('toggleMemberDots')[0].style.visibility = 'hidden';
        // document.getElementsByClassName('toggleSelector')[0].style.visibility = 'hidden';
        // viz2zoomedInG.attr('visibility', 'hidden');
    });
...
new ScrollMagic.Scene({
  ...
  triggerHook: 'onLeave'
    ...
    .on('enter', function(e) {
      ...
      $('#viz2Text').text('In 1885, for the first time since the 1950s, both chambers had a Republican majority. In reaction, democrats more left sharply.');
    });
...
new ScrollMagic.Scene({
  ...
  triggerHook: 'onLeave'
    ...
    .on('enter', function(e) {
      ...
      $('#viz2Text').text('However, since then, the Democrats have been moving further leftwards at a much slower rate than the Republicans are moving rightwards.');
    });
  ...
  triggerHook: 'onLeave'
    ...
    .on('enter', function(e) {
      ...
      $('#viz2Text').text('Feel free to explore the visualization. When ready, scroll down.');
        document.getElementsByClassName('toggleCentroid')[0].style.visibility = 'visible';
        document.getElementsByClassName('toggleMemberDots')[0].style.visibility = 'visible';
        document.getElementsByClassName('toggleSelector')[0].style.visibility = 'visible';
        viz2zoomedInG.attr('visibility', 'visible');
    });
