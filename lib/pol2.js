...
let pol2globalWidth = 1200, pol2globalHeight = 1000;
...
let legendG = pol2mainG.append('g')
    .attr('transform', function(){
        var tempX = pol2globalWidth  * 2 / 3;
        var tempY = pol2paddings.top;
        return 'translate('+[tempX, tempY]+')'
    });
...
.then(function(dataset) {
    ...
    var textG = labelG.append('g')
        .attr('transform', function(){
            var tempX = pol2globalWidth / 4;
            var tempY = -pol2globalHeight / 2;
            return 'translate('+[tempX, tempY]+')'
        });
