...
var lineChartOnlyG = pol2mainG.append('g');
...
var lineChartG = lineChartOnlyG.append('g')
...
.then(function(dataset) {
    ...
    for (var i = 0; i < votesByCongress.length; i++) {
        ...
        curPercentageG = percentageG.append('g')
            .attr('transform', function(){
                var tempX = curXOffset;
                var tempY = 0;
                return 'translate('+[tempX, tempY]+')'
        ...
        //curPercentageG.parentElement.append(curPercentageG);
...
d3.selectAll('.toggleLineChart')
    .on('click', function() {
        if (lineVisible == true) {
            ...
            percentageG.selectAll('rect').transition().duration(500).style('opacity', 0);
            ...
            percentageG.selectAll('rect').transition().duration(500).style('opacity', 1);
