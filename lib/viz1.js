...
var tooltip1 = d3.tip()
    ...
    .offset([-12, 0])
    .html(function(d) {
        return "<div id=tip_container1><div id=rep_text>Democratic Party Median</div><div id=custom_tip_dem><div id=tip_dem_score>" + d.median_dim1 + "</div></div></div";
    });
...
var tooltip2 = d3.tip()
    ...
    .offset([-12, 0])
    .html(function(d) {
        return "<div id=tip_container1><div id=rep_text>Republican Party Median</div><div id=custom_tip_rep><div id=tip_rep_score>" + d.median_dim1 + "</div></div></div";
    });
