...
var globalWidth = screen.width, globalHeight = screen.height*8/10;
...
var zoomedInWidth = globalWidth / 7;
    ...
    */
    ...
    function showPersonDetail(icpsr) {
        ...
        personDots = personDotsG.selectAll('circle')
            ...
            .attr('cy', function(d) {
                return viz1yScale(icpsrToPersonMap[icpsr].dim1)
            })
            .attr('r', function(d) {
                return 8;
            })
...
*/
    ...
    var XaxisLabelModifier = mainVizXAxis.selectAll(".tick text")
     .attr("font-size","0.6rem")
     .attr("font-family",'IBM Plex Mono')
     .attr("color","#FFFFFF")

    var YaxisLabelModifier = mainVizYAxis.selectAll(".tick text")
    .attr("font-size","0.6rem")
    .attr("font-family",'IBM Plex Mono')
    .attr("color","#FFFFFF")
    ...
    */
    ...
    memberCircleG.selectAll('circle')
        ...
        .attr('r', function(d) {
            ...
            else if (d.chamber === 'President') return 4; // president
        ...
        .style('fill', function(d) {
            ...
            else if (d.chamber === 'President') return '#EAC268'; // president
