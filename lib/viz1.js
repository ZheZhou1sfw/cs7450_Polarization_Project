...
var tooltip3 = d3.tip()
    ...
    .offset([-12, 0])
    .html(function(d) {
        return "<div id=custom_tip2><div id=tip_median_score>" + "</div><div id=tip_text><strong></strong><br>" + ((2*(d.congress-1)+1789)) + " - " +  ((2*(d.congress-1)+1789)+2) + " , " + d.congress + "th Congress</div></div>";
    });
