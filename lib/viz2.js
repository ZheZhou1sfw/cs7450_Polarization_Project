...
let viz2globalWidth = screen.width * 10 / 11, viz2globalHeight = screen.height*(8.5/10)  ;
...
viz2legendG.selectAll('text').attr('fill', 'yellow');
...
//console.log(path);
    ...
    d3.json("../lib/states-10m.json").then(function(topology) {
        ...
        var projection = d3.geoAlbersUsa().scale([320]);
