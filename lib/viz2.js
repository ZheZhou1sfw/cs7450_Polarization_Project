...
let viz2globalWidth = screen.width * 10 / 11, viz2globalHeight = screen.height * 2 / 4  ;
...
let viz2stateG = viz2svg.append('g')
    ...
    .attr('transform', function() {
        var left = viz2paddings.left + 500;
        var top = viz2paddings.top + 400;
...
var zoomedInPos = {
    left: viz2globalWidth / 20,
    top: viz2paddings.top + 30,
};
...
var zoomedInWidth = viz2globalWidth / 4;
var zoomedInHeight = viz2globalHeight / 3;

var zoomedInFrame = viz2zoomedInG.append('rect')
    .attr('x', 0)
    .attr('y', 0)
...
var viz2legendG = viz2svg.append('g')
    .attr('transform', function() {
        ...
        var tempHeight = viz2globalHeight / 15;
...
var politicianCountG = viz2svg.append('g')
    .attr('transform', function() {
        var tempWidth = viz2globalWidth * 4 / 5;
        var tempHeight = viz2globalHeight / 3;
        return 'translate('+[tempWidth, tempHeight]+')'
});
...
.then(function(dataset) {
    ...
    yScale = d3.scaleLinear()
        .domain([-1, 1])
        .range([viz2globalHeight - viz2paddings.top - viz2paddings.bottom, 0]);
